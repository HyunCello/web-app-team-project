...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('#tab > div').forEach(function (each) {
        each.addEventListener('click', function (event) {
            var questionSlide = document.querySelector('#question');
    ...
    // ADD 버튼 클릭했을 때
    document.querySelector('#make_question').addEventListener('click', function (event) {
        event.stopPropagation();
        var modal = document.querySelector('.modal-make-question-wrap');
    ...
    document.querySelector('.modal-make-question-wrap').addEventListener('click', function (event) {
    ...
    document.querySelector('.btn-quest-submit').addEventListener('click', function (event) {
        console.log('click');
